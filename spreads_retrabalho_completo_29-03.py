...
if processo == "Fabricação":
    ...
    lista_de_fixacoes = ["Elevador", "Base - Fixação do Eletroimã", "Base - Colagem do Vinil", "Base - Colagem da Flange A, B, C"]
    ...
    while indice < len(lista_de_pre_fab):
        ...
        opcoesfabricacao = tk.OptionMenu(window, optionsfabricacao, "OPF0052/2021 Base Leitor", "OPF0053/2021 Torre Leitor",
                                         command=salvarfabricacao)  # config da combobox de opf
