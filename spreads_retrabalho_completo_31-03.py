...
if processo == "Fabricação":
    ...
    lista_de_fixacoes = ["Inspeção da Tampa", "Colagem Vinil", "Colagem Capsense", "Contagem"]
    ...
    while indice < len(lista_de_pre_fab):
        ...
        opcoesfabricacao = tk.OptionMenu(window, optionsfabricacao, "OPF0054/2021 Tampa", "OPF0055/2021 Solda Capsense", "OPF0056/2021 Led Direito","OPF0057/2021 Led Esquerdo","OPF0058/2021 Eletroimãn",
                                         command=salvarfabricacao)  # config da combobox de opf
