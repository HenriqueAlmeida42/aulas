...
#credentials = ServiceAccountCredentials.from_json_keyfile_name('chaveagatha.json', scope)
# Se autentica
...
#wks = gc.open_by_key('1N0EHlqCtWRqZJgpfPdoZwkmT7m7UttseRLMNCF3-ss0')
...
if processo == "Fabricação":
    ...
    lista_de_soldas = ["Capsense", "Barramento Esquerdo", "Barramento Direito", "Eletroimã", "Contagem"]
    lista_de_gravacoes = ["DART", "STM", "HUB"]
    lista_de_fixacoes = ["Inspeção da Tampa", "Colagem Vinil", "Colagem Capsense", "Contagem", "Elevador, Bateria & Estabilizador", "Colagem do Espelho", "Fabricação de Elevador"]
    ...
    while indice < len(lista_de_pre_fab):
        ...
        opcoesfabricacao = tk.OptionMenu(window, optionsfabricacao, "OPF0060/2021 Tampa", "OPF0061/2021 Torre", "OPF0063/2021 Led Direito","OPF0064/2021 Led Esquerdo","OPF0061/2021 Torre",
                                         command=salvarfabricacao)  # config da combobox de opf
